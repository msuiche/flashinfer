...
`SiLU()`, and `Identity()`. SM100 retains the existing SwiGLU pool; the new
activations have not been executed on SM100 hardware. Availability is checked
...
- SM100a or SM107a (Rubin), BF16 input/weights/output, finalized output;
