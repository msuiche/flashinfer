...
# Tile config: CONFIG_sm100_128x128x128_128x128x32_cluster1x1_1ctamma
mma_inst_shape_mnk = (128, 128, 16)
mma_k_dim = 0
cta_group = 1
cgrp_tile_mnk = (128, 128, 64)
...
epi_stage_rows = 128
epi_chunk_elems = 16
ab_stages = 6  # SMEM-D 0B fixed + cast LOAD 0B/stage + multi-GEMM 16384B/stage
...
@cute.kernel
def frost_sm100_moe_grouped_matmul_fwd_128x128x128_128x128x32_cluster1x1_1ctamma_stg(
    m: cutlass.Int64,
    n: cutlass.Int64,
    k: cutlass.Int64,
...
frost_sm100_moe_grouped_matmul_fwd_128x128x128_128x128x32_cluster1x1_1ctamma_stg.set_name_prefix("cudnn", remove_cutlass_symbol=True)
...
def _host(
    ...
    frost_sm100_moe_grouped_matmul_fwd_128x128x128_128x128x32_cluster1x1_1ctamma_stg(
        problem_size[0],
        problem_size[1],
        problem_size[2],
...
def compile() -> Callable:
    ...
    return cute.compile(_host, problem_size, fake_first_token_offset, fake_a_tma_workspace, fake_a_0, fake_b_0, fake_b_1, fake_c_tap_0, fake_scale, stream=_fake_stream, options=frost_compile_options)
