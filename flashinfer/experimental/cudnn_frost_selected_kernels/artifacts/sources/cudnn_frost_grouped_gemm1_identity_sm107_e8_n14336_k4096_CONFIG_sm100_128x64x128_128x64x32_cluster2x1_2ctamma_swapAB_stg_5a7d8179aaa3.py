...
acc_stages = 2  # 64 acc cols/stage
                    ...
                    if row_active and row < M:
                        for j in cutlass.range_constexpr(subtile_w // vsize):
                            ...
                            if col_j < group_end:
                                ...
                                _tap_0 = (_r_0).to(cutlass.BFloat16)
...
def compile() -> Callable:
    ...
    return cute.compile(_host, problem_size, fake_first_token_offset, fake_tma_workspace, fake_a_0, fake_b_0, fake_c_tap_0, fake_scale, stream=_fake_stream, options=frost_compile_options)
