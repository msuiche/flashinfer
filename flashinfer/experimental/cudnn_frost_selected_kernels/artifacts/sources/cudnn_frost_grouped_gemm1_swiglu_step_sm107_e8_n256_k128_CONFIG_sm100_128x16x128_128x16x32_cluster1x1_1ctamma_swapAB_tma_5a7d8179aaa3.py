...
epi_stage_rows = 128
epi_chunk_elems = 16
ab_stages = 9  # SMEM-D 8208B fixed + cast LOAD 0B/stage + multi-GEMM 16384B/stage
...
@cute.kernel
def frost_sm100_moe_grouped_matmul_fwd_swap_ab_128x16x128_128x16x32_cluster1x1_1ctamma_swapAB(
    m: cutlass.Int64,
    n: cutlass.Int64,
    k: cutlass.Int64,
        ...
        while is_valid != 0:
            ...
            for mi in cutlass.range_constexpr(mma_size_m):
                ...
                for subtile_idx in cutlass.range_constexpr(subtile_cnt):
                    ...
                    _tsv_0 = cutlass.Array(base=smem_d_ptr.data_ptr(epi_stage_idx * epi_subtile_elems), shape=2048, dtype=cutlass.BFloat16)
                    _mrow_0 = tidx % 64
                    _mblk_0 = (tidx // 64) * 1024
                    _mx0_0 = _mrow_0 ^ 0
                    _mx1_0 = _mrow_0 ^ 8
                    _mx2_0 = _mrow_0 ^ 16
                    _mx3_0 = _mrow_0 ^ 24
...
frost_sm100_moe_grouped_matmul_fwd_swap_ab_128x16x128_128x16x32_cluster1x1_1ctamma_swapAB.set_name_prefix("cudnn", remove_cutlass_symbol=True)
...
def _host(
    ...
    frost_sm100_moe_grouped_matmul_fwd_swap_ab_128x16x128_128x16x32_cluster1x1_1ctamma_swapAB(
        problem_size[0],
        problem_size[1],
        problem_size[2],
