...
@cute.kernel
def frost_sm100_moe_grouped_matmul_fwd_128x256x128_128x256x32_cluster2x1_2ctamma(
    m: cutlass.Int64,
    n: cutlass.Int64,
    k: cutlass.Int64,
...
frost_sm100_moe_grouped_matmul_fwd_128x256x128_128x256x32_cluster2x1_2ctamma.set_name_prefix("cudnn", remove_cutlass_symbol=True)
...
def _host(
    ...
    frost_sm100_moe_grouped_matmul_fwd_128x256x128_128x256x32_cluster2x1_2ctamma(
        problem_size[0],
        problem_size[1],
        problem_size[2],
