...
def compile() -> Callable:
    ...
    return cute.compile(_host, problem_size, fake_first_token_offset, fake_a_tma_workspace, fake_a_0, fake_b_0, fake_c_0, stream=_fake_stream, options=frost_compile_options)
