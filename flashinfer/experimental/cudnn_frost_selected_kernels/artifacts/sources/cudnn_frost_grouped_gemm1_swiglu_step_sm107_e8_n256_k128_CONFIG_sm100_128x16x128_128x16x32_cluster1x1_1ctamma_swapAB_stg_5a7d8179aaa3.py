...
# Tile config: CONFIG_sm100_128x16x128_128x16x32_cluster1x1_1ctamma_swapAB
mma_inst_shape_mnk = (128, 16, 16)
mma_k_dim = 0
cta_group = 1
cgrp_tile_mnk = (128, 16, 64)
cta_tile_mnk = (128, 16, 64)
epi_tile_mn = (128, 16)
threads_per_cta = 256
...
acc_stages = 2  # 32 acc cols/stage
...
epi_stage_rows = 128
epi_chunk_elems = 1
ab_stages = 9  # SMEM-D 0B fixed + cast LOAD 0B/stage + multi-GEMM 16384B/stage
...
@cute.kernel
def frost_sm100_moe_grouped_matmul_fwd_swap_ab_128x16x128_128x16x32_cluster1x1_1ctamma_swapAB_stg(
    m: cutlass.Int64,
    n: cutlass.Int64,
    k: cutlass.Int64,
...
frost_sm100_moe_grouped_matmul_fwd_swap_ab_128x16x128_128x16x32_cluster1x1_1ctamma_swapAB_stg.set_name_prefix("cudnn", remove_cutlass_symbol=True)
...
def _host(
    ...
    frost_sm100_moe_grouped_matmul_fwd_swap_ab_128x16x128_128x16x32_cluster1x1_1ctamma_swapAB_stg(
        problem_size[0],
        problem_size[1],
        problem_size[2],
