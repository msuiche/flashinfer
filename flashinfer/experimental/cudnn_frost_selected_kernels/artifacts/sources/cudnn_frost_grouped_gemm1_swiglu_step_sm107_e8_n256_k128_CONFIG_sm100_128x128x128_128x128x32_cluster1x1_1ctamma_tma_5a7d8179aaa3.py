...
epi_stage_rows = 128
epi_chunk_elems = 32
ab_stages = 6  # SMEM-D 16400B fixed + cast LOAD 0B/stage + multi-GEMM 16384B/stage
...
@cute.kernel
def frost_sm100_moe_grouped_matmul_fwd_128x128x128_128x128x32_cluster1x1_1ctamma(
    m: cutlass.Int64,
    n: cutlass.Int64,
    k: cutlass.Int64,
...
frost_sm100_moe_grouped_matmul_fwd_128x128x128_128x128x32_cluster1x1_1ctamma.set_name_prefix("cudnn", remove_cutlass_symbol=True)
...
def _host(
    ...
    frost_sm100_moe_grouped_matmul_fwd_128x128x128_128x128x32_cluster1x1_1ctamma(
        problem_size[0],
        problem_size[1],
        problem_size[2],
...
def compile() -> Callable:
    ...
    return cute.compile(_host, problem_size, fake_first_token_offset, fake_a_tma_workspace, fake_a_0, fake_b_0, fake_b_1, fake_scale, fake_c_0, stream=_fake_stream, options=frost_compile_options)
