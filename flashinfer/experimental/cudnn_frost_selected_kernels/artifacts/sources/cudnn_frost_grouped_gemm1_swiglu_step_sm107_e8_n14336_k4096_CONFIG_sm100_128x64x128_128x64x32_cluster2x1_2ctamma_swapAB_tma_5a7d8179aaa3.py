...
epi_stage_rows = 128
epi_chunk_elems = 32
ab_stages = 8  # SMEM-D 16400B fixed + cast LOAD 0B/stage + multi-GEMM 16384B/stage
...
@cute.kernel
def frost_sm100_moe_grouped_matmul_fwd_swap_ab_128x64x128_128x64x32_cluster2x1_2ctamma_swapAB(
    m: cutlass.Int64,
    n: cutlass.Int64,
    k: cutlass.Int64,
...
frost_sm100_moe_grouped_matmul_fwd_swap_ab_128x64x128_128x64x32_cluster2x1_2ctamma_swapAB.set_name_prefix("cudnn", remove_cutlass_symbol=True)
...
def _host(
    ...
    frost_sm100_moe_grouped_matmul_fwd_swap_ab_128x64x128_128x64x32_cluster2x1_2ctamma_swapAB(
        problem_size[0],
        problem_size[1],
        problem_size[2],
