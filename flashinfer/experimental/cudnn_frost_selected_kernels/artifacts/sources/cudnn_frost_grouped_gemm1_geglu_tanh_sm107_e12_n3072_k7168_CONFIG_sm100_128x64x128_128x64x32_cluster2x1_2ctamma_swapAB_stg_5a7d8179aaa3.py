                    ...
                    if row_active and row < M:
                        for j in cutlass.range_constexpr(subtile_w // vsize):
                            ...
                            if col_j < group_end:
                                ...
                                _g_x0 = _c_0_a
                                _g_inner0 = cutlass.full_like(_g_x0, cutlass.Float32(0.7978845608028654)) * (_g_x0 + cutlass.full_like(_g_x0, cutlass.Float32(0.044715)) * _g_x0 * _g_x0 * _g_x0)
                                _g_tanh0 = (cutlass.full_like(_g_inner0, cutlass.Float32(1.0)) - cutlass.full_like(_g_inner0, cutlass.Float32(2.0)) * cute.math.rcp(cute.math.exp2(_g_inner0 * cutlass.full_like(_g_inner0, cutlass.Float32(2.8853900817779268)), fastmath=True) + cutlass.full_like(_g_inner0, cutlass.Float32(1.0)), approx=True, ftz=True))
                                _op_0 = cutlass.full_like(_g_x0, cutlass.Float32(0.5)) * _g_x0 * (cutlass.full_like(_g_x0, cutlass.Float32(1.0)) + _g_tanh0)
                                ...
                                _tap_0 = (_r_2).to(cutlass.BFloat16)
